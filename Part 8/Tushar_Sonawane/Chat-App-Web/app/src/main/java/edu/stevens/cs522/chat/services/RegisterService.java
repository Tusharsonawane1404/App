    ...
    public int onStartCommand(@NonNull Intent intent, int flags, final int startId) {
       ...
       Intent activityIntent = new Intent(this, RegisterActivity.class);
        ...
        Notification.Action cancelAction =
                new Notification.Action.Builder(icon, getString(R.string.register_cancel_button_label), cancelPendingIntent).build();
            ...
            try {
                ...
                mainLoop.post(() -> {
                    ...
                    if (registerResponse != null && !(registerResponse instanceof ErrorResponse)) {
                        ...
                        Notification notification1 = new NotificationCompat.Builder(this, channelId).setSmallIcon(R.drawable.ic_chat).setContentText(getString(R.string.registered_notification_message)).build();
                        ...
                        Notification notification1 = new NotificationCompat.Builder(this,channelId).setSmallIcon(R.drawable.ic_chat).setContentText(getText(R.string.register_failed_notification_message)).build();
                        notificationManager.notify(notificationId,notification1);
