...
public class ViewPeersActivity extends FragmentActivity implements TextAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PeersViewModel peersVwModel = new ViewModelProvider(this).get(PeersViewModel.class);
        LiveData<List<Peer>> peersLiveData = peersVwModel.fetchAllPeers();


        // TODO observer for list of peers updates the peer adapter
        peersLiveData.observe(this, peers -> {
            //if (peers != null) {
