...
public class ViewPeerActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PeerViewModel peerVwModel = new ViewModelProvider(this).get(PeerViewModel.class);

        // TODO query the database asynchronously, and use messagesAdapter to display the result
        LiveData<List<Message>> messagesLiveData = peerVwModel.fetchMessagesFromPeer(peer);
